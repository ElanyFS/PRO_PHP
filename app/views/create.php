<div class="container_form">
    ...
    <form class="form" action="/create" method="post">
        ...
        <div class="form_grupo">
            ...
            <input type="text" name="cpf" class="form_input" id="cpf" placeholder="11111111111" required>
        </div>
        <div class="form_grupo">
            <label for="nome" class="form_label">Função</label>
            <input type="text" name="funcao" class="form_input" id="funcao" placeholder="Gestor(a)" required>
        </div>
        <div class="form_grupo">
        ...
        <div class="form_grupo">
            ...
            <input type="text" name="endereco" class="form_input" id="endereco" placeholder="Calhau" required>
        </div>
        <div class="form_grupo">
            <label for="nome" class="form_label">Cidade</label>
            <input type="text" name="cidade" class="form_input" id="cidade" placeholder="São Luís" required>
        </div>
        <div class="form_grupo">
        ...
        <div class="form_grupo">
            ...
            <input type="password" name="password" class="form_input" id="password" placeholder="123456" required>
        </div>
        <div class="form_grupo">
