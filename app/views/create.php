...
<div class="container_form">
    ...
    <?php echo getcsrf(); ?>
        ...
        <div class="form_grupo">
            ...
            <input type="email" name="email" class="form_input" id="email" placeholder="seuemail@email.com" value="<?php echo getOld('email');?>">
            <?php echo getFlash('email') ?>
        </div>
        <div class="form_grupo">
            <label for="nome" class="form_label">Senha</label>
            <input type="password" name="password" class="form_input" id="password" placeholder="123456" value="<?php echo getOld('password');?>">
